...
### Text Sentiment Analysis and Word Cloud of the Top 50 Words in *Catcher in the Rye* by J.D. Salinger
...
# find top 25 words in the book
top_25_words <- nonstop_counts %>% 
  arrange(-n) %>% 
  slice(1:25)
...
# ggplot(top_25_words, aes(x = word, y = n)) +
#   geom_col(fill = "blue") +
#   coord_flip()

# make a word cloud
catcher_cloud <- ggplot(data = top_50_words, aes(label = word)) +
  geom_text_wordcloud(aes(color = n, size = n), shape="diamond") +
  scale_size_area(max_size = 8) +
  labs(title = "Top 50 Words in Catcher in the Rye") +
  theme(plot.title = element_text(hjust = 0.5)) +
